...
Pod::Spec.new do |s|
  ...
  s.author             = { "kshg" => "kjdxkshg@sina.com" }
  # Or just: s.author    = "kshg"
  # s.authors            = { "kshg" => "kjdxkshg@sina.com" }
  # s.social_media_url   = "http://twitter.com/kshg"
  ...
  s.source       = { :git => "https://github.com/kshg/KSGBUAdSDK.git", :tag => "#{s.version}" }
